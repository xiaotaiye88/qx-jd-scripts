...
用法:
  ...
  python3 tools/ws_convert.py --ql "http://QL_SERVER_PLACEHOLDER" "token" --all
"""
...
if __name__ == "__main__":
    if "--all" in sys.argv:
        ...
        print("  WSKEY_PROXY=http://192.168.0.235:7890 python3 tools/ws_convert.py --ql http://QL_SERVER_PLACEHOLDER TOKEN --all")
